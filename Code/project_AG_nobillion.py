                        ...
                        if currentArticle.count(state)>0:
                                ...
                                for project in dict4:
                                        if currentArticle.count(project)>0:
                                                ...
                                                money=re.findall(r'\$ ?[0-9]+,[0-9]+,[0-9]+|\$ ?[0-9]+,[0-9]+|\$ ?[0-9]+ million|\$ ?[0-9]+ million dollar|million-dollar\$ ?[0.9]+.[0-9]+ million|\$ [0.9]+.[0-9]+ million dollar|[0.9]+.[0-9]+ million dollar', currentArticle.lower())
                                                if money!=[]:
